...
final class HDOTP_Hub
{
    ...
    public static function render_overview()
    {
        ...
        $plugins = array(
            ...
            array('name' => 'Affiliate & Referral Program', 'file' => 'hdwebmobile-affiliate-program/hdwebmobile-affiliate-program.php', 'description' => 'Referral links earn commission on completed orders -- payouts are always admin-approved, self-referral is blocked server-side.'),
            array('name' => 'Age Verification Gate', 'file' => 'hdwebmobile-age-verification/hdwebmobile-age-verification.php', 'description' => 'Restrict age-gated products behind a confirmation prompt -- verification state lives server-side in the session, re-checked at add-to-cart and checkout, never trusted from a client-set cookie.'),
            ...
            array('name' => 'Bulk Pricing', 'file' => 'hdwebmobile-bulk-pricing/hdwebmobile-bulk-pricing.php', 'description' => 'Quantity-tiered discounts for any product -- rule config is capability- and nonce-gated, and every label is escaped at output.'),
            array('name' => 'Buy Now Button', 'file' => 'hdwebmobile-buy-now/hdwebmobile-buy-now.php', 'description' => 'Skip the cart with a direct Buy Now button -- price and quantity are always computed server-side from the real product, never accepted from the link.'),
            ...
            array('name' => 'Coupon Links & Conditions', 'file' => 'hdwebmobile-coupon-links/hdwebmobile-coupon-links.php', 'description' => 'Cart-condition coupons and apply-by-link URLs -- a coupon link only ever applies an existing published coupon by exact code, and coupon rules are capability- and nonce-gated.'),
            ...
            array('name' => 'Custom Order Numbers', 'file' => 'hdwebmobile-custom-order-numbers/hdwebmobile-custom-order-numbers.php', 'description' => 'Give orders a custom-formatted display number -- the real order ID always determines access, never the display number.'),
            array('name' => 'Data Privacy Requests', 'file' => 'hdwebmobile-data-privacy-requests/hdwebmobile-data-privacy-requests.php', 'description' => 'Let customers request their own WooCommerce data be exported or erased from My Account -- always scoped to their own account, reusing WordPress\'s own core privacy-request system.'),
            ...
            array('name' => 'Local Pickup & Delivery Zones', 'file' => 'hdwebmobile-delivery-zones/hdwebmobile-delivery-zones.php', 'description' => 'Postcode-based delivery zones and pickup locations with a per-zone fee -- the fee actually charged is always looked up server-side from the zone id, never accepted from the request.'),
            ...
            array('name' => 'Order Bump', 'file' => 'hdwebmobile-order-bump/hdwebmobile-order-bump.php', 'description' => 'A one-click discounted add-on offer at checkout -- the price charged is always the admin\'s own configured price, never accepted from the request.'),
            ...
            array('name' => 'Order Quantity Rules', 'file' => 'hdwebmobile-order-quantity-rules/hdwebmobile-order-quantity-rules.php', 'description' => 'Minimum, maximum, and step order-quantity rules -- enforced server-side on every checkout path, not just in the cart page\'s own JS.'),
            ...
            array('name' => 'Post-Purchase Upsell', 'file' => 'hdwebmobile-post-purchase-upsell/hdwebmobile-post-purchase-upsell.php', 'description' => 'A one-click upsell offer on the order-received page -- the original order is always verified by its real key, and the upsell price is always computed server-side.'),
            ...
            array('name' => 'Product Comparison', 'file' => 'hdwebmobile-product-comparison/hdwebmobile-product-comparison.php', 'description' => 'Compare products side by side -- only real, published, publicly visible products are ever shown, re-checked fresh every time, never trusted from a stored id.'),
            ...
            array('name' => 'Product Filters', 'file' => 'hdwebmobile-product-filters/hdwebmobile-product-filters.php', 'description' => 'Filter the shop by attribute, price, category, stock and rating -- every filter is applied through WordPress\'s own query API, never placed into a SQL string.'),
            ...
            array('name' => 'Product Specifications', 'file' => 'hdwebmobile-product-specifications/hdwebmobile-product-specifications.php', 'description' => 'Add a specifications table to any product -- editable only by users who can edit that specific product.'),
            array('name' => 'Recent Sales Notifications', 'file' => 'hdwebmobile-recent-sales-notifications/hdwebmobile-recent-sales-notifications.php', 'description' => 'A recent-purchase popup -- returns only pre-aggregated, non-identifying data, never a raw customer record.'),
            ...
            array('name' => 'Sales Countdown', 'file' => 'hdwebmobile-sales-countdown/hdwebmobile-sales-countdown.php', 'description' => 'Sale countdown timers and low-stock urgency labels -- the "only N left" figure is read live from real stock, and all copy is admin-only and escaped.'),
            array('name' => 'Secure Downloads', 'file' => 'hdwebmobile-secure-downloads/hdwebmobile-secure-downloads.php', 'description' => 'Let customers securely retrieve their WooCommerce download links using their real order number and order key -- no file path is ever read from a request.'),
            ...
            array('name' => 'Size Charts', 'file' => 'hdwebmobile-size-charts/hdwebmobile-size-charts.php', 'description' => 'Add size charts to product categories -- edited only through a capability- and nonce-checked admin form.'),
            ...
            array('name' => 'Wholesale Pricing', 'file' => 'hdwebmobile-wholesale-pricing/hdwebmobile-wholesale-pricing.php', 'description' => 'Role-based wholesale prices with a gated application form -- the wholesale role is granted only by an admin approval, never by any request.'),
